...
_config_dict = dict(
    ...
    MODEL=dict(
        ...
        TEST_WEIGHTS="/home/allen/MI-projects/SGTR/weights_test/sgtr_vg_new_pth/model_0095999.pth",

        # WEIGHTS="/storage/data/lirj2/ckpts/vg_detr.pth",
        WEIGHTS="/home/allen/MI-projects/SGTR/weights_backbone/detr_vg_ckpt.pth",
    ...
    DATASETS=dict(
        ...
        PROPOSAL_FILES_TEST="/home/allen/MI-projects/SGTR/vg_rcnnfpn_precompute_box/vgs_val",
        PROPOSAL_FILES_TRAIN="/home/allen/MI-projects/SGTR/vg_rcnnfpn_precompute_box/train_new",
    ...
    SOLVER=dict(
        ...
        # IMS_PER_DEVICE=6,
        IMS_PER_BATCH=12,  # 2卡时候的batchsize
        IMS_PER_DEVICE=6,
