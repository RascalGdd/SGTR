...
_PREDEFINED_SPLITS_4DOR_SGDET = {
    "dataset_type": "DORDataset",  # visual genome stanford split
    "evaluator_type": {
        "oi": 'oi_sgg',
    },
    "or": {
        "or_train": ("4dor/4D-OR_img", "4dor/annotations/4DOR-train-anno.json"),
        "or_val": ("4dor/4D-OR_img", "4dor/annotations/4DOR-val-anno.json"),
        "or_test": ("4dor/4D-OR_img", "4dor/annotations/4DOR-val-anno.json"),
    }
}

PATH_ROUTES.register(_PREDEFINED_SPLITS_4DOR_SGDET, "OR")
