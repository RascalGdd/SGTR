...
from .paths_route import _PREDEFINED_SPLITS_4DOR_SGDET
...
@DATASETS.register()
class DORDataset(VGStanfordDataset):
    ...
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        ...
        (fg_matrix, bg_matrix,
         (rel_counter_init, ent_counter_init)) = get_VG_statistics(self, must_overlap=False)   #  这里把must_overlap从True改成了False
    ...
    def _get_metadata(self):
        meta = {}
        image_root, json_file = _PREDEFINED_SPLITS_4DOR_SGDET['or'][self.name]
        ...
        meta["evaluator_type"] = _PREDEFINED_SPLITS_4DOR_SGDET["evaluator_type"]['oi']
